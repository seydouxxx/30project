...
class ViewController: UIViewController {
    ...
    func configureView(weatherInformation: WeatherInformation) {
        ...
        self.tempLabel.text = "\(Int(weatherInformation.temp.temp - 273.15))ºC"
        self.minTempLabel.text = "\(Int(weatherInformation.temp.minTemp - 273.15))ºC"
        self.maxTempLabel.text = "\(Int(weatherInformation.temp.maxTemp - 273.15))ºC"
    }
